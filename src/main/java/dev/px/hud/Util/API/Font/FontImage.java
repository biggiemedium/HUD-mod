    ...
    public int getStringWidth(String text) {
        ...
        for (int character : text.toCharArray()) {
            ...
            if (characterLocations.length <= index || fontCharacter == null) {
                width += mc.fontRendererObj.getStringWidth(String.valueOf(character)) / 4;
                continue;
            }
    ...
    public void drawString(String text, double x, double y, int color) {
        ...
        for (char character : text.toCharArray()) {
            ...
            if (Character.getNumericValue(character) >= characterLocations.length) {
                ...
                mc.fontRendererObj.drawString(String.valueOf(character), (float) offset * 0.25F + 1, 2F, color, false);
                offset += (double) mc.fontRendererObj.getStringWidth(String.valueOf(character)) * 4;
