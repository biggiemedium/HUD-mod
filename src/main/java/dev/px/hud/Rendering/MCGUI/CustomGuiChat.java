...
public class CustomGuiChat extends GuiNewChat {
    ...
    public CustomGuiChat(Minecraft mcIn) {
        super(mcIn);
        this.mc = mcIn;
    }
    ...
    public void drawChat(int updateCounter) {
        ...
        if (this.mc.gameSettings.chatVisibility != EntityPlayer.EnumChatVisibility.HIDDEN) {
            ...
            if (j > 0) {
                ...
                if (HUDMod.elementInitalizer.getElementByClass(ChatModifications.class) != null && HUDMod.elementInitalizer.getElementByClass(ChatModifications.class).isToggled()
                        && !this.isScrolled) GlStateManager.translate(2.0F + xOffset, 8.0F + yOffset + (9 - 9*percent)*f1, 0.0F);
                else GlStateManager.translate(2.0F + xOffset, 8.0F + yOffset, 0.0F);
                        ...
                        if (j1 < 200 || flag) {
                            ...
                            if (l1 > 3) {
                               ...
                               // }
                                ...
                                if (smooth && i1 <= newLines) { // BetterChat.getSettings().smooth &&
    ...
    private void setChatLine(IChatComponent chatComponent, int chatLineId, int updateCounter, boolean displayOnly) {
        ...
        int i = MathHelper.floor_double((float) this.getChatWidth() / this.getChatScale());
    ...
    public IChatComponent getChatComponent(int mouseX, int mouseY) {
        if (!this.getChatOpen()) {
            ...
            int j = mouseX / i - 2 - xOffset;
            int k = mouseY / i - 40 + yOffset;
            j = MathHelper.floor_double((float) j / f);
            k = MathHelper.floor_double((float) k / f);

            if (j >= 0 && k >= 0) {
                int l = Math.min(this.getLineCount(), this.drawnChatLines.size());

                if (j <= MathHelper.floor_double((float) this.getChatWidth() / this.getChatScale()) && k < this.mc.fontRendererObj.FONT_HEIGHT * l + l) {
