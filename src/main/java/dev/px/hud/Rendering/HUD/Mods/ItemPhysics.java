...
public class ItemPhysics extends ToggleableElement {

    public ItemPhysics() {
        super("Item Physics", "", HUDType.RENDER);
    }
    ...
    public Setting<Float> rotationSpeed = create(new Setting<>("Rotation Speed", 1.0f, 0.1f, 5.0f));


    public void itemPhysic(Entity entity, double d, double d2, double d3) {
        EntityItem entityItem;
        ItemStack itemStack;
        Field1899 = (double) (System.nanoTime() - Field1898) / 2500000.0 * (double) rotationSpeed.getValue();
